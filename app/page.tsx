...
>
  <Image
    ...
    width={62}
    height={62}
    className="object-contain drop-shadow-lg-[0_0_12px_rgba(255,255,255,0.5)]"
  />
    ...
    CitizenConnect
      ...
      <section className="relative flex flex-col items-center justify-center text-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            🟢 Road repair – In Progress • 🔴 Water supply – Pending • 🟣 Streetlight fixed – Resolved
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-16 max-w-6xl mx-auto">
            ...
            <Link href="/citizen/dashboard"
              ...
              <h3 className="text-lg font-semibold mb-2">Citizen Panel</h3>
            ...
            <Link href="/politician/dashboard"
              className="bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10 
                         ...
                         transition duration-300 text-center">
              <h3 className="text-lg font-semibold mb-2">Politician Panel</h3>
              <p className="text-sm text-gray-400">
            ...
            <Link href="/moderator/dashboard"
              className="bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10 
                         ...
                         transition duration-300 text-center">
              <h3 className="text-lg font-semibold mb-2">Moderator Panel</h3>
              <p className="text-sm text-gray-400">
